...
namespace leccion1cliente
{
    public partial class Form1 : Form
    {
        ...
        private void cel_bt_Click(object sender, EventArgs e)
        {
            string mensaje = "1/" + grados_tb.Text;
            ...
            MessageBox.Show("Los grados en Celsius son " + mensaje);
        }

        private void far_bt_Click(object sender, EventArgs e)
        {
            string mensaje = "2/" + grados_tb.Text;
            // Enviamos al servidor la fecha tecleada
            byte[] msg = System.Text.Encoding.ASCII.GetBytes(mensaje);
            server.Send(msg);
